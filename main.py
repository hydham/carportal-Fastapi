...
# update car details using PUT - http method with ID passed as Path Parameter and new fields as Request Body
...
# delete a car from database - car_id passed as path parameter in the URL
